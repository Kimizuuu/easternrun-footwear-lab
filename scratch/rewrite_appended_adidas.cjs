...
const baseContent = content.slice(0, cutoff);

const appendedAdidas = `,\n  {
    id: 'adidas_primex2strung',
...
fs.writeFileSync(file, baseContent + appendedAdidas, 'utf8');
console.log('✅ Cleanly re-written appended Adidas shoes!');
